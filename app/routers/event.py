...
from app.utils import http_helper, logger
...
def update_event(payload: event_schema.UpdateEvent,
    ...
    try:
        ...
        event.venue = payload.venue or event.venue
        event.title = payload.title or event.title
        event.venue_lat = payload.venue_lat or event.venue_lat
        event.venue_lng = payload.venue_lng or event.venue_lng
